...
### Результаты:  
Запустив [этот замечательный код](https://github.com/V3ence/DS_education/blob/main/project_0/game_v2.py), мы получаем отличный результат: среднее количество попыток = 5!!!
