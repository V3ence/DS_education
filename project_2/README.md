...
### Описание проекта.    
Проанализировать данные для дальнейшего создание модели машинного обучения, которая будет рекомендовать вакансии клиентам кадрового агентства, претендующим на позицию Data Scientist
...
**Что практикуем**     
- Подробный анализ данных и приведение его в законченную, логичную форму. 
